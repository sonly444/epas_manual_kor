# ALTER SYNONYM — EPAS 18 Reference

> 원문: [EPAS v18 — Reference › Oracle 호환 › 호환 SQL 명령 › ALTER SYNONYM](https://www.enterprisedb.com/docs/epas/latest/reference/oracle_compatibility_reference/epas_compat_sql/11a_alter_synonym/)
> EPAS v18 공식 문서의 한글 **전문 번역**입니다. 명령·코드 이름은 원문 그대로 보존했습니다.

## 이름 (Name)

`ALTER SYNONYM` — 시노님(synonym) 객체의 소유권을 변경합니다.
...
`ALTER SYNONYM` 명령은 시노님의 소유자를 변경합니다.
